...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _interest = __webpack_require__(40);

	var _interest2 = _interopRequireDefault(_interest);

	var _interestList = __webpack_require__(41);
	...
	var App = function (_Component) {
	    ...
	    function App() {
	        ...
	        Object.assign(_this, _reactIntl2.default);
	    ...
	    _createClass(App, [{
	        ...
	        value: function componentDidUpdate() {
	            ...
	            _helpers2.default.fetchMessages().then(function (data) {
	                this.setState({ messages: data });
	            }.bind(this));

	            (0, _i18n2.default)(e.target.value, this.setProps, this);
	        }
	    }, {
	        key: 'render',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'col-md-3' },
	                            _react2.default.createElement(_chat2.default, { setMessage: this.setMessage, messages: this.state.messages })
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	...
	function renderApp(i18n) {
	    ...
	    var App = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./index.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    _reactDom2.default.render(_react2.default.createElement(App, i18n), document.querySelector('.root'));
	}

	var defaultLocale = document.documentElement.getAttribute('lang');

	(0, _i18n2.default)(defaultLocale, renderApp);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Interest = function (_Component) {
	  _inherits(Interest, _Component);

	  function Interest(props) {
	    _classCallCheck(this, Interest);

	    var _this = _possibleConstructorReturn(this, (Interest.__proto__ || Object.getPrototypeOf(Interest)).call(this, props));
	  ...
	  _createClass(Interest, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'panel-heading heading-area textStyle', id: 'headingArea' },
	          _react2.default.createElement(
	            'h4',
	            { className: 'textStyle' },
	            ' Name your activity'
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'panel-body interestTopList textStyle' },
	          _react2.default.createElement(
	            'form',
	            { id: 'interestForm' },
	            _react2.default.createElement(
		...
		_createClass(Login, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "navbar navbar-default headerBackground logoArea " },
						_react2.default.createElement("div", { className: "pizzaLogo" }),
						_react2.default.createElement(
							"div",
							null,
							_react2.default.createElement(
								"button",
								{ className: "loginButton mdl-button mdl-js-button mdl-js-ripple-effect" },
								_react2.default.createElement(
									"i",
									{ className: "material-icons iconSize loginButton" },
									"account_circle"
								),
								"Sign-in with Google"
							)
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { className: "panel-body gmaps textStyle" },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //TODO make it so initial state loads up all prev messages
		...
		_createClass(Chat, [{
			...
			value: function showMessages() {
				if (this.props.messages) {
					return this.props.messages.map(function (x, i) {
						return _react2.default.createElement(_message2.default, { key: i, body: x.body, date: x.date });
					});
				}
			...
			value: function handleSubmit() {
				...
				_helpers2.default.createMessage(this.state.message);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'form',
						{ id: 'chat-form', onSubmit: function onSubmit(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var helper = {
		...
		fetchMessages: function fetchMessages() {
			return new Promise(function (resolve, reject) {
				fetch('/lastTwentyMessages').then(function (response) {
					return response.json();
				}).then(function (responseData) {
					console.log("responseData: " + responseData);
					resolve(responseData);
	...
	var Filters = function (_Component) {
		...
		_createClass(Filters, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'panel panel-default panel-border bottom', id: 'btnBox' },
					_react2.default.createElement(
						'h4',
						{ className: 'panel-heading heading-area textStyle' },
						'Narrow your search'
	   ...
	   _createClass(Slider, [{
	      ...
	      value: function showActions() {
	         ...
	         return _react2.default.createElement(
	            ...
	            'Min Age : ',
	            _react2.default.createElement('input', { type: 'range', min: '1', max: '5', name: 'val_brightness', value: this.state.val_brightness, onChange: function onChange(e) {
	                  _this2.handleChange(e);
	               } }),
	            _react2.default.createElement('br', null),
	            'Max Age : ',
	            _react2.default.createElement('input', { type: 'range', min: '1', max: '5', value: this.state.val_blur, name: 'val_blur', onChange: function onChange(e) {
	                  _this2.handleChange(e);
	               } })
	         );
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function zh(cb, scope) {
	  if (!hasIntl) __webpack_require__.e/* nsure */(1, function (require) {
	    console.log('Loaded bundle for it (with Intl)');
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"intl/locale-data/jsonp/zh.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    var i18n = __webpack_require__(52);
	    cb.call(scope, i18n);
	  });else {
	...
	function en(cb, scope) {
	  if (!hasIntl) __webpack_require__.e/* nsure */(2, function (require) {
	    console.log('Loaded bundle for en (with Intl)');
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"intl/locale-data/jsonp/en.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	module.exports = function (locale, cb, scope) {
	  if (!hasIntl) !/* require.ensure */(function (require) {
	    __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"intl/Intl\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	    loaders[locale](cb, scope);
	  }(__webpack_require__));else loaders[locale](cb, scope);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var allLocaleData = _interopDefault(__webpack_require__(55));
	var IntlMessageFormat = _interopDefault(__webpack_require__(56));
	var IntlRelativeFormat = _interopDefault(__webpack_require__(66));
	var React = __webpack_require__(1);
	var React__default = _interopDefault(React);
	var invariant = _interopDefault(__webpack_require__(73));
	var memoizeIntlConstructor = _interopDefault(__webpack_require__(74));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IntlMessageFormat = __webpack_require__(57)['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var src$core$$ = __webpack_require__(58), src$en$$ = __webpack_require__(64);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	"use strict";
	var src$utils$$ = __webpack_require__(59), src$es5$$ = __webpack_require__(60), src$compiler$$ = __webpack_require__(61), intl$messageformat$parser$$ = __webpack_require__(62);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	"use strict";
	var src$utils$$ = __webpack_require__(59);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(63)['default'];
	exports['default'] = exports;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var IntlRelativeFormat = __webpack_require__(67)['default'];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var src$core$$ = __webpack_require__(68), src$en$$ = __webpack_require__(71);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	"use strict";
	var intl$messageformat$$ = __webpack_require__(56), src$diff$$ = __webpack_require__(69), src$es5$$ = __webpack_require__(70);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var src$es5$$ = __webpack_require__(76);
